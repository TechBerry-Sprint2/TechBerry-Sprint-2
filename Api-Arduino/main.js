    ...
    arduino.pipe(new serialport.ReadlineParser({ delimiter: '\r\n' })).on('data', async (data) => {
        ...
        if (HABILITAR_OPERACAO_INSERIR) {
            ...
            if (AMBIENTE == 'producao') {
                ...
                sqlquery = `INSERT INTO medida VALUES (${dht11Temperatura}, ${dht11Umidade}, CURRENT_TIMESTAMP, 2000);`;
                //CURRENT_TIMESTAMP
                // CREDENCIAIS DO BANCO REMOTO - SQL SERVER
                const connStr = `   Server=techberry.database.windows.net;
                                    Database=techberry;
                                    User Id=techberry;
                                    Password=TBgrupo8;`;
                ...
                await poolBancoDados.execute(
                    `INSERT INTO medida VALUES (null, ${dht11Temperatura}, ${dht11Umidade}, now(), 2000);`
                );
                console.log("valores inseridos no banco: ", dht11Umidade + ", " + dht11Temperatura + ", " + luminosidade + ", " + lm35Temperatura + ", " + chave)
